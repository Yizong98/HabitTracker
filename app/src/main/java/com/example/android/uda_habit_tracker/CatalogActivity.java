...
public class CatalogActivity extends AppCompatActivity {
     ...
     * the pets database.
     */
    public Cursor queryDatabaseInfo() {
    ...
    private void displayDatabaseInfo(){
        ...
        try {
            ...
            int numberColumnIndex = cursor.getColumnIndex(HabitEntry.COLUMN_HABIT_NUMBER);
    ...
    private void insertHabit() {
        ...
        values.put(HabitEntry.COLUMN_HABIT_NAME, "Soccer");
        values.put(HabitEntry.COLUMN_HABIT_PLACE, "Artificial Grass");
        values.put(HabitEntry.COLUMN_HABIT_NUMBER, "Group");
        values.put(HabitEntry.COLUMN_HABIT_DURATION, 7);
